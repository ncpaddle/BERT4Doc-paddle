...
paddle_p = paddle.load('../../../../furthered_imdb_pretrained/model_state.pdparams')
torch_p = torch.load('../../../../furthered_imdb_pretrained/pytorch_model.bin', map_location=torch.device('cpu'))
