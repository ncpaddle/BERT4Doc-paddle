...
torch_model_path = "../furthered_imdb_pretrained/pytorch_model.bin"
torch_state_dict = torch.load(torch_model_path)

paddle_model_path = "../furthered_imdb_pretrained/model_state.pdparams"
paddle_state_dict = {}
...
for torch_key in torch_state_dict:
    ...
    if ('linear' in paddle_key) or ('proj' in  paddle_key) or \
            ...
            ("dense.weight" in paddle_key) or ('transform.weight' in paddle_key) or \
            ('seq_relationship.weight' in paddle_key) or \
            ('classifier' in paddle_key):
